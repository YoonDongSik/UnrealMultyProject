...
void EmptyLinkFunctionForGeneratedCodeHorrorGame_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_HorrorGame()
	{
		if (!Z_Registration_Info_UPackage__Script_HorrorGame.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_HorrorGame_OnHealthChanged__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_HorrorGame_OnStaminaChanged__DelegateSignature,
			};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_HorrorGame(Z_Construct_UPackage__Script_HorrorGame, TEXT("/Script/HorrorGame"), Z_Registration_Info_UPackage__Script_HorrorGame, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0xF8F15E9E, 0xF6577100));
