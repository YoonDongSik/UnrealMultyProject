...
struct Z_Construct_UClass_AMainPlayerController_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_InterectionAction_MetaData[] = {
		{ "Category", "Mapping" },
		{ "ModuleRelativePath", "MainPlayerController.h" },
	};
	...
	static const UECodeGen_Private::FObjectPropertyParams NewProp_InterectionAction;
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AMainPlayerController_Statics::NewProp_InterectionAction = { "InterectionAction", nullptr, (EPropertyFlags)0x0020080000010015, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AMainPlayerController, InterectionAction), Z_Construct_UClass_UInputAction_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_InterectionAction_MetaData), NewProp_InterectionAction_MetaData) };
...
void Z_Construct_UClass_AMainPlayerController_Statics::NewProp_bIsPickUp_SetBit(void* Obj)
{
	((AMainPlayerController*)Obj)->bIsPickUp = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AMainPlayerController_Statics::NewProp_bIsPickUp = { "bIsPickUp", nullptr, (EPropertyFlags)0x0020080000010005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AMainPlayerController), &Z_Construct_UClass_AMainPlayerController_Statics::NewProp_bIsPickUp_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bIsPickUp_MetaData), NewProp_bIsPickUp_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AMainPlayerController_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AMainPlayerController_Statics::NewProp_InterectionAction,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AMainPlayerController_Statics::NewProp_bIsCrouch,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AMainPlayerController_Statics::NewProp_bIsPickUp,
};
...
struct Z_CompiledInDeferFile_FID_HorrorGame_Source_HorrorGame_MainPlayerController_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AMainPlayerController, AMainPlayerController::StaticClass, TEXT("AMainPlayerController"), &Z_Registration_Info_UClass_AMainPlayerController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMainPlayerController), 1035602245U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HorrorGame_Source_HorrorGame_MainPlayerController_h_3583332096(TEXT("/Script/HorrorGame"),
